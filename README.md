...
![Data Model](https://github.com/TrungTNguyenn/Hospital-Project-I/assets/149715744/f4f6fc2f-cbc0-4927-b706-3475ca50544e)
...
***Query 3: Returns all doctors who have not written any prescriptions.***
...
**Query 4: Returns the average total of all overdue payments.***
...
***Query 5: Returns the patient’s initial assessment/reason for visit, first and last name, for all patients born after January 1st, 2000 in ascending order***
...
***Query 6: Returns the first and last name of the patient who received an ultrasound. Also shows the results and the day/time it was ordered by the doctor.***
...
***Query 7: Returns the total amount of times each patient has visited the clinic in descending order.***
...
***Query 8: Returns the total amount overdue, first and last name, and patientID for each patient.***
...
***Query 9: Returns the average amount of prescriptions for each patient.***
...
***Query 10: Returns the total amount of paid bills, sorted by each year, at all clinics.***
